...
public class StaffAllotment extends JFrame {
	...
	StaffAllotment(){
			...
			allot.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					try {
						PreparedStatement st=DatabaseConnection.getConnection().prepareStatement("insert into allotment values(?,?,?,?,?,?)");
						st.setString(1, name.getText());
						st.setString(2, login.getText());
						st.setString(3, dept.getSelectedItem().toString());
